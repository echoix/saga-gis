; To build installer (for example, saga-7.1.1_setup.exe).
; - Unzip the SAGA binary files in their own folder (for example, saga-7.1.1.zip).
...
OutputDir=.
OutputBaseFilename=saga-7.1.1_win32_setup

VersionInfoVersion=7.1.1.0
...
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA GIS\7.1.1"; ValueType: string; ValueName: "InstallDir"; ValueData: "{app}"; Flags: uninsdeletekey
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA GIS\7.1.1"; ValueType: string; ValueName: "Version"; ValueData: "7.1.1.0"

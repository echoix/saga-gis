; To build installer (for example, saga-8.3.1_setup.exe).
; - Unzip the SAGA binary files in their own folder (for example, saga-8.3.1.zip).
...
OutputDir=.
OutputBaseFilename=saga-8.3.1_win32_setup

VersionInfoVersion=8.3.1.0
...
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA\8.3.1"; ValueType: string; ValueName: "InstallDir"; ValueData: "{app}"; Flags: uninsdeletekey
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA\8.3.1"; ValueType: string; ValueName: "Version"; ValueData: "8.3.1.0"

; To build installer (for example, saga-8.0.2_setup.exe).
; - Unzip the SAGA binary files in their own folder (for example, saga-8.0.2.zip).
...
OutputDir=.
OutputBaseFilename=saga-8.0.2_win32_setup

VersionInfoVersion=8.0.2.0
...
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA\8.0.2"; ValueType: string; ValueName: "InstallDir"; ValueData: "{app}"; Flags: uninsdeletekey
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA\8.0.2"; ValueType: string; ValueName: "Version"; ValueData: "8.0.2.0"

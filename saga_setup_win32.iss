...
OutputDir=.
OutputBaseFilename=saga-4.0.1_win32_setup
...
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA GIS\4.0.1"; ValueType: string; ValueName: "InstallDir"; ValueData: "{app}"; Flags: uninsdeletekey
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA GIS\4.0.1"; ValueType: string; ValueName: "Version"; ValueData: "4.0.1.0"

; To build installer (for example, saga-8.4.3_setup.exe).
; - Unzip the SAGA binary files in their own folder (for example, saga-8.4.3.zip).
...
OutputDir=.
OutputBaseFilename=saga-8.4.3_win32_setup

VersionInfoVersion=8.4.3.0
...
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA\8.4.3"; ValueType: string; ValueName: "InstallDir"; ValueData: "{app}"; Flags: uninsdeletekey
Root: HKLM; Subkey: "SOFTWARE\SAGA User Group Association\SAGA\8.4.3"; ValueType: string; ValueName: "Version"; ValueData: "8.4.3.0"
